...
it on any static host, or push to `main` and let
`.github/workflows/deploy.yml` build and publish it to GitHub Pages
automatically (set the repo's Pages source to "GitHub Actions").
